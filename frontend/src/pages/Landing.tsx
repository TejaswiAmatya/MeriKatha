...
const wisdomCards: Array<{ nepali: string; english: string }> = [
  ...
  {
    nepali: '"एक हात ले ताली बज्दैन।"',
    english: "Help maag na yaar. Eklai sab garna pardaina.",
  },
  {
    nepali: '"धीरे धीरे रे मना, धीरे सब कुछ होय।"',
    english: "Hustle culture lai bhetaunu pardaina. Afno pace maa thik cha.",
  },
];
...
const strings = {
  np: {
    ...
    circlesBody:
      "Yahan groups chan — diaspora, nayi aama, career, ghar bhitra ko kura.",
    ...
    footerTagline:
      "Safe to open in front of family. · Koi login chaina. · Koi judgment chaina.",
  ...
  en: {
    ...
    footerTagline:
      "Safe to open in front of family. · No login. · No judgment.",
    footerMade: "Made with 🙏 for Nepali women, everywhere.",
  },
} as const;
...
const circles = [
  {
    ...
    initial: "न",
    color: "bg-himalayan",
    tagline: "Nayi aamaharuko lagi",
    taglineEn: "For new mothers",
  },
  {
    id: "Pardesh",
    name: "परदेश",
    initial: "प",
    color: "bg-maroon",
    tagline: "Bidesh maa Nepali didi",
    taglineEn: "Nepali women abroad",
  },
  {
    id: "SathiCircle",
    name: "साथी",
    initial: "स",
    color: "bg-marigold",
    tagline: "Sanga, sab thau",
    taglineEn: "Together, everywhere",
  },
  {
    id: "PadhneBahini",
    name: "पढ्ने बहिनी",
    initial: "ब",
    color: "bg-sindoor",
    tagline: "Career + padhailai",
    taglineEn: "Career and education",
  },
];
...
const features = [
  {
    ...
    descEn:
      "Share your story — anonymously. No one judges here. Just listening.",
    preview: (
    ...
    <div className="bg-pageBg min-h-screen font-sans">
      ...
      <header className="sticky top-0 z-40 h-12 bg-transparent border-b border-transparent flex items-center justify-between px-5 md:px-8">
        <div className="flex items-center gap-2">
          ...
          <span className="font-serif font-bold text-ink text-lg leading-none">
            छाया
          </span>
        </div>
      ...
      >
        ...
        <section className="relative overflow-hidden -mt-12 min-h-screen">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(245,240,230,0.55) 0%, rgba(245,240,230,0.72) 50%, rgba(245,240,230,1) 100%)",
            }}
          />
          ...
          <div className="max-w-3xl mx-auto px-5 pt-32 pb-20 md:pt-40 md:pb-28 text-center relative">
            ...
            <h1 className="font-serif font-bold text-5xl md:text-7xl text-ink leading-tight mt-3">
              {s.heroH1Line1}
              <br />
              <span className="text-sindoor">{s.heroH1Highlight}</span>{" "}
              {s.heroH1Line2}
            </h1>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {features.map((f) => (
                <div
                  key={f.id}
                  className={`${f.bg} rounded-2xl p-5 flex flex-col`}
                >
                  {/* Icon */}
                  {f.iconBg ? (
                    <div
                      className={`w-10 h-10 ${f.iconBg} rounded-xl flex items-center justify-center text-xl`}
                    >
                      {f.icon}
                    </div>
                  ) : (
                  ...
                  {/* Title */}
                  <p
                    className={`font-serif font-bold text-xl mt-3 leading-tight ${f.id === "diyo" ? "text-[#F5E6C8]" : "text-ink"}`}
                  >
                    {f.titleDev}
                  </p>
                  <p
                    className={`text-[10px] font-sans mt-0.5 ${f.id === "diyo" ? "text-[#D4A882]" : "text-textMuted"}`}
                  >
                    {f.titleEn}
                  </p>
                  ...
                  {/* Description */}
                  <p
                    className={`text-sm mt-2 leading-relaxed font-sans flex-1 ${f.id === "diyo" ? "text-[#D4A882]" : "text-textBody"}`}
                  >
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 snap-x snap-mandatory md:grid md:grid-cols-4 md:overflow-visible md:pb-0">
              {circles.map((c) => (
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-full ${c.color} flex items-center justify-center shrink-0`}
                  >
                  ...
                  <div className="min-w-0">
                    <p className="font-serif font-bold text-sm text-ink leading-tight">
                      {c.name}
                    </p>
        ...
        >
          <div className="max-w-5xl mx-auto">
            <div className="bg-maroon rounded-2xl p-8 md:p-10 text-center">
              ...
              />
              <p
                className="text-sm italic font-sans"
                style={{ color: "#D4A882" }}
              >
                {s.wisdomReframe}
              </p>
